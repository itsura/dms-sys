 ...
 * <p>
 * The {@link org.dms.sys.namespace.QNamePattern QNamePattern} is implemented
...
public final class QName implements QNamePattern, Serializable, Cloneable, Comparable<QName>
{
    ...
    /** The Constant EMPTY_URI_SUBSTITUTE. */
    ...
    /** The Constant NAMESPACE_PREFIX. */
    public static final char NAMESPACE_PREFIX = ':';
    
    /** The Constant NAMESPACE_BEGIN. */
    public static final char NAMESPACE_BEGIN = '{';
    
    /** The Constant NAMESPACE_END. */
     ...
     * @return the QName
     * @throws InvalidQNameException the invalid q name exception
     */
        ...
        throws InvalidQNameException, NamespaceException
    {
        ...
        if (prefix == null)
        {
            prefix = Namespaces.DEFAULT_PREFIX; 
        }
        ...
        throws InvalidQNameException, NamespaceException
    {
        ...
        if (qname != null)
        {
            ...
            String prefix = (colonIndex == -1) ? Namespaces.DEFAULT_PREFIX : qname.substring(0, colonIndex);
    ...
    {   
        this.namespaceURI = ((namespace == null) || (namespace.equals(QName.EMPTY_URI_SUBSTITUTE))) ? Namespaces.DEFAULT_URI : namespace;
        this.prefix = prefix;
        this.localName = name;
        this.hashCode = 0;
    }
    ...
    public String toPrefixString(NamespacePrefixResolver prefixResolver)
    {
        ...
        if (pref.equals(Namespaces.DEFAULT_PREFIX))
        {
            return localName;
        }
        else
    ...
    public static QName resolveToQName(NamespacePrefixResolver prefixResolver, String str)
    {
        ...
        else
        {
            ...
            qname = createQName(Namespaces.CONTENT_MODEL_1_0_URI, str);
        }
    ...
    public static String resolveToQNameString(NamespacePrefixResolver prefixResolver, String str)
    {
        ...
        if (str.charAt(0) != NAMESPACE_BEGIN)
        {
            ...
            {
                // there's no namespace so prefix with Alfresco's Content Model
                result = new StringBuilder(64).append(NAMESPACE_BEGIN).append(Namespaces.CONTENT_MODEL_1_0_URI)
